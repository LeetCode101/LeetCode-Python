...
class Solution:
    ...
    def _find_max(self, root, min_value, max_value):
        ...
        max_left = self._find_max(root.left, min_value, max_value) if root.left else abs(min_value - max_value)
        max_right = self._find_max(root.right, min_value, max_value) if root.right else abs(min_value - max_value)
